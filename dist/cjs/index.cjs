...
const StyledSourceHeading = styled__default["default"].div.withConfig({
  displayName: "EditorSections__StyledSourceHeading",
  componentId: "sc-1nr6ndr-1"
})(["font-size:var(--tina-font-size-0);font-weight:700;letter-spacing:0.04em;text-transform:uppercase;color:", ";padding:4px;margin-top:12px;&:first-child{margin-top:0;}"], easyblocksDesignSystem.Colors.black40);
const EditorSections = ({
  ...
  const [categoriesBySource, setCategoriesBySource] = React.useState(null);
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(StyledEditorSectionGroup, {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, {
      key: entry.id
    }, startsLibrary && /*#__PURE__*/React__default["default"].createElement(StyledSourceHeading, null, entry.sourceLabel), /*#__PURE__*/React__default["default"].createElement(EditorSectionItem, {
      id: entry.id,
      name: entry.label,
      kind: entry.kind,
