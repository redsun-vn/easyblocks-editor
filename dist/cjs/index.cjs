...
function FieldsBuilder({
  ...
  return /*#__PURE__*/React__default["default"].createElement(FieldsGroup, null, identityField !== undefined && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(FieldBuilder, {
    field: identityField,
    form: form
  }), horizontalLine), isEmptyField ? /*#__PURE__*/React__default["default"].createElement(EmptyField, null) : null, Object.keys(grouped).map(groupName => /*#__PURE__*/React__default["default"].createElement("div", {
    key: groupName
...
const ColorConfigurations = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement(ColorConfigurationsContainer, null, themeOptions.map(themeOption => /*#__PURE__*/React__default["default"].createElement(StyledColorWrapper, {
    ...
    onKeyDown: onEnterChangeColor
  }), colorInputError ? /*#__PURE__*/React__default["default"].createElement(StyleColorError, null, colorInputError) : null), /*#__PURE__*/React__default["default"].createElement(StyledButtonGroup, null, /*#__PURE__*/React__default["default"].createElement(easyblocksDesignSystem.ButtonSecondary, {
...
const StyledEditorLayerRoot = styled__default["default"].div.withConfig({
  displayName: "EditorLayer__StyledEditorLayerRoot",
  componentId: "sc-vnm02d-1"
})(["overflow-x:hidden;"]);
const StyledEditorLayer = styled__default["default"].div.withConfig({
