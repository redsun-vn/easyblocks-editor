...
})(["position:absolute;top:var(", ");left:var(", ");border-radius:4px;box-shadow:var(--tina-shadow-big);display:var(", ",none);padding:5px 10px;width:max-content;background:", ";opacity:", ";pointer-events:", ";transition:opacity 120ms ease-out;"], SELECTION_ACTIONS_TOP, SELECTION_ACTIONS_LEFT, SELECTION_ACTIONS_DISPLAY, easyblocksDesignSystem.Colors.white, ({
  $isRevealed
}) => $isRevealed ? 1 : 0, ({
  $isRevealed
}) => $isRevealed ? "all" : "none");
...
function TextField({
  ...
  return (
    ...
    React__default["default"].createElement(FieldMetaWrapper, {
      input: input,
      field: field,
      layout: "column",
      noWrap: noWrap
...
const LocalFieldPlugin = {
  ...
  Component: function LocalField(props) {
    ...
    }), /*#__PURE__*/React__default["default"].createElement(LocalFieldWidget, props));
  }
};
...
function FieldsBuilder({
  ...
  return /*#__PURE__*/React__default["default"].createElement(FieldsGroup, null, identityField !== undefined && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(FieldBuilder, {
    ...
    key: groupName
  }, /*#__PURE__*/React__default["default"].createElement(FieldsGroupLabel, null, translatePanelGroup(groupName, t)), grouped[groupName].map((field, index, fields) => /*#__PURE__*/React__default["default"].createElement(FieldWrapper, {
...
})(["display:flex;align-items:center;gap:10px;width:100%;padding:5px 6px;border:1px solid transparent;border-radius:6px;background:transparent;text-align:left;font:inherit;color:inherit;cursor:pointer;user-select:none;-webkit-user-drag:element;&:hover{background:", ";border-color:", ";}&:focus-visible{outline:2px solid ", ";outline-offset:-1px;}&:disabled{cursor:default;}"], easyblocksDesignSystem.Colors.black5, easyblocksDesignSystem.Colors.black10, easyblocksDesignSystem.Colors.blue50);
...
const EditorSections = ({
   ...
   */
  const scrollCanvasToComponent = React.useCallback(path => {
    let attempts = 0;
  ...
  const onAddTemplate = React.useCallback((template, indexOverride) => {
   ...
   */
  const draggedTemplate = React.useRef(null);
  React.useEffect(() => {
...
function SelectionFrame({
  ...
  const revealActions = React.useCallback(isPointerNear => {
  ...
  React.useLayoutEffect(() => () => clearTimeout(fadeTimer.current), []);
  React.useLayoutEffect(() => {
...
const SectionCard = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement(CardRoot, null, /*#__PURE__*/React__default["default"].createElement(ImageContainer, {
    ...
    src: previewImage
  }), !previewImage && shownThumbnailLabel && /*#__PURE__*/React__default["default"].createElement(CardImgPlaceholder, null, /*#__PURE__*/React__default["default"].createElement("span", {
    style: {
      color: "#6c6c6c"
    }
  }, shownThumbnailLabel)), !previewImage && !shownThumbnailLabel && /*#__PURE__*/React__default["default"].createElement(CardImgPlaceholder, null, /*#__PURE__*/React__default["default"].createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "64",
    height: "64",
    viewBox: "0 0 16 16",
    ...
    fill: easyblocksDesignSystem.Colors.black20
  })))), /*#__PURE__*/React__default["default"].createElement(CardFooter, null, /*#__PURE__*/React__default["default"].createElement(CardLabelContainer, null, /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, shownLabel && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(CardLabelTemplateName, null, shownLabel)))), /*#__PURE__*/React__default["default"].createElement("div", null), template.isUserDefined && !editorContext.readOnly && /*#__PURE__*/React__default["default"].createElement(buttons.ButtonGhostColor, {
...
function usePanelDropTarget() {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(AcceptFrame, null), target ? /*#__PURE__*/React__default["default"].createElement(InsertionLine, {
    y: target.y
  }) : null);
}
...
function DragHandleGlyph() {
  return /*#__PURE__*/React__default["default"].createElement("svg", {
    ...
    "aria-hidden": "true",
    focusable: "false"
  }, [2, 7, 12].flatMap(cy => [2, 8].map(cx => /*#__PURE__*/React__default["default"].createElement("circle", {
    key: `${cx}-${cy}`,
    cx: cx,
    cy: cy,
    r: "1.5"
...
function SelectionFrameController({
  ...
  const wrapperClassName = stitches.css({
    ...
    [`&[data-drop-rejected=true][data-draggable-dragging=true]${HOVERED_TARGET_FRAME}::after`]: {
      opacity: 1,
      borderColor: easyblocksDesignSystem.Colors.red,
      borderWidth: "2px",
      borderStyle: "dashed",
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    onClick: onSelect
  }, isDraggable && /*#__PURE__*/React__default["default"].createElement("div", _extends__default["default"]({
    ...
    ,
    onClick: event => event.stopPropagation()
  }, sortable.attributes, sortable.listeners), /*#__PURE__*/React__default["default"].createElement(DragHandleGlyph, null)), edgeDropTargets, dropRejectionMessage !== undefined && /*#__PURE__*/React__default["default"].createElement("div", {
...
function BlocksControls({
   ...
   */
  const isDropTarget = !!sortable$1.active && !isDroppableDisabled && !isBlockBeingDragged && (overId === id || overId === `${id}.before` || overId === `${id}.after`);
...
function EasyblocksCanvas({
  ...
  })), /*#__PURE__*/React__default["default"].createElement(core.DragOverlay, {
    dropAnimation: null,
    style: {
      pointerEvents: "none"
    }
