...
export declare const PANEL_DRAG_MIME = "application/x-easyblocks-panel-item";
 ...
 */
export declare function resolvePanelDropTarget(pointerY: number, rects: SectionRect[]): PanelDropTarget;
/** Whether a drag event is one of ours, asked at a moment when only types are readable. */
export declare function isPanelDrag(types: readonly string[] | undefined): boolean;
export {};
//# sourceMappingURL=panelDrag.d.ts.map