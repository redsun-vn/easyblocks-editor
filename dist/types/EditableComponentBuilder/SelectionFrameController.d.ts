...
declare function SelectionFrameController({ isActive, children, onSelect, stitches, sortable, id, direction, path, label, isDraggable, dropRejectionMessage, dropIndicatorEdge, isDropContainer, isDropTarget, edgeDropTargets, }: SelectionFrameControllerProps): React.JSX.Element;
