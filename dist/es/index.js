...
function FrameGrads({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("linearGradient", {
    id: `${id}Fill`,
    x1: "0",
    y1: "0",
    x2: "1",
...
function MobilePortraitFrame({
  ...
  }, /*#__PURE__*/React__default.createElement("defs", null, /*#__PURE__*/React__default.createElement(FrameGrads, {
    id: "mobP"
...
function DeviceFrame({
  ...
  return /*#__PURE__*/React__default.createElement(FrameWrap, null, /*#__PURE__*/React__default.createElement(FrameBox, {
    $width: width,
    $height: height,
    $transform: transform
  }, family === "mobile-portrait" && /*#__PURE__*/React__default.createElement(MobilePortraitFrame, {
    width: width,
    height: height
  }), family === "mobile-landscape" && /*#__PURE__*/React__default.createElement(MobileLandscapeFrame, {
    width: width,
    height: height
  }), family === "tablet-portrait" && /*#__PURE__*/React__default.createElement(TabletPortraitFrame, {
    width: width,
    height: height
  }), family === "tablet-landscape" && /*#__PURE__*/React__default.createElement(TabletLandscapeFrame, {
    width: width,
    height: height
  }), family === "laptop" && /*#__PURE__*/React__default.createElement(LaptopFrame, {
    width: width,
    height: height
  }), family === "desktop" && /*#__PURE__*/React__default.createElement(DesktopFrame, {
    width: width,
    height: height
  })));
}
...
function EditorIframe({
  ...
  }), /*#__PURE__*/React__default.createElement(DeviceFrame, {
    viewport: viewport,
    width: width,
    height: height,
    transform: transform,
...
function SidebarFooter(props) {
  ...
  return /*#__PURE__*/React.createElement(SidebarFooterContainer, null, /*#__PURE__*/React.createElement(HorizontalLine$4, null), /*#__PURE__*/React.createElement(IdWrapper, null, showSaveAsTemplate ? /*#__PURE__*/React.createElement(ButtonWrapper, null, showSaveAsTemplate && mode !== "admin" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ButtonSecondary, {
    icon: Icons.Save1,
    hideLabel: true,
    onClick: () => {
  ...
  }, t("template.save")), /*#__PURE__*/React.createElement(ButtonSecondary, {
    style: {
      minWidth: "auto"
    },
    icon: Icons.SaveAs,
 ...
 */
function translateUnder(text, prefix, t) {
...
function translatePanelGroup(group, t) {
 ...
 */
function translatePanelLabel(label, t) {
  const asKey = t(label);
  if (asKey !== label) {
    return asKey;
  }
...
const SelectFieldComponent = ({
  ...
  const normalizedSelectOptions = selectOptions.map(option => toProps(option, t));
  if (isMixedValue) {
 ...
 */
function toProps(option, t) {
  if (typeof option === "object") {
    return "isDivider" in option ? option : {
      ...option,
      label: translatePanelLabel(option.label, t)
    };
  }
  return {
    value: option,
    label: translatePanelLabel(option, t)
  };
}
...
const CustomField = ({
  ...
  switch (tokenTypeDefinition?.token) {
    ...
    case "colors":
      {
        return /*#__PURE__*/React__default.createElement(ColorCustomFields, {
          field: field,
          input: input
        });
      }
 ...
 */
const Trigger$1 = styled(RadixSelectTrigger).withConfig({
...
const ColorFieldPlugin = ({
  ...
  if (type === "grid") {
    ...
    }, /*#__PURE__*/React__default.createElement(Trigger$1, null, /*#__PURE__*/React__default.createElement(RadixSelectValue, {
      placeholder: "Select item"
    }), /*#__PURE__*/React__default.createElement(ChevronDownIcon, {
      color: Colors.black40
    })), /*#__PURE__*/React__default.createElement(RadixSelectPortal, null, /*#__PURE__*/React__default.createElement(Content$2, null, /*#__PURE__*/React__default.createElement(SelectTitle, null, t("theme.colors")), /*#__PURE__*/React__default.createElement(Viewport, {
      shape: "rectangle"
...
function TokenFieldComponent({
  ...
  const customInputElement = shouldShowCustomValueInput ? /*#__PURE__*/React__default.createElement("div", {
    ...
    params: "params" in field.schemaProp ? field.schemaProp.params : undefined
  }) : ["fonts", "colors"].includes(tokenTypeDefinition.token) ? /*#__PURE__*/React__default.createElement(CustomField, {
    input: input,
    field: field
  }) : /*#__PURE__*/React__default.createElement(Input, {
    value: inputValue,
...
function IdentityField({
  ...
  return /*#__PURE__*/React__default.createElement(IdentityFieldContainer, null, /*#__PURE__*/React__default.createElement(IdentityFieldWrapper, null, /*#__PURE__*/React__default.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      flex: "1 0"
...
function FieldsBuilder({
  ...
  const matchesQuery = field => {
    ...
    const group = field.group ? normalize(translatePanelGroup(field.group, t)) : "";
  ...
  return /*#__PURE__*/React__default.createElement(FieldsGroup, null, identityField !== undefined && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(FieldBuilder, {
  ...
  }), query !== "" && /*#__PURE__*/React__default.createElement(SearchClearButton, {
    type: "button",
    ...
    form: form,
    isLabelHidden: field.schemaProp.isLabelHidden
  }))), !Object.keys(grouped).length && !ungrouped.length && !isEmptyField ? /*#__PURE__*/React__default.createElement(NoData, {
    variant: "body"
  }, t("noData"), "!") : /*#__PURE__*/React__default.createElement(React__default.Fragment, null), !isEmptyField ? horizontalLine : null);
}
...
const ColorCard = ({
  ...
  return /*#__PURE__*/React__default.createElement(StyledColorCard, {
    background: themeOption[backgroundColor].value,
    onClick: openModal
  }, /*#__PURE__*/React__default.createElement(Icons.Pencil, {
    size: 18
  }));
};
const ColorConfigurations = ({
  ...
  }, t("theme.colors.reset")), /*#__PURE__*/React__default.createElement(Modal, {
...
const FontConfigurations = ({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Container, null, themeOptions.map(themeOption => /*#__PURE__*/React__default.createElement(StyledFontWrapper, {
    ...
    variant: "body",
    component: "label"
  }, t("theme.font.reset.confirm")))), openEditFont ? /*#__PURE__*/React__default.createElement(Modal, {
    width: "30vw",
    maxHeight: "auto",
    ...
    mode: "center-small",
    headerLine: true
  }, /*#__PURE__*/React__default.createElement(Content$1, null, /*#__PURE__*/React__default.createElement(Form$1, {
    onSubmit: onSubmit
  }, /*#__PURE__*/React__default.createElement(Row, null, /*#__PURE__*/React__default.createElement(StyledSelect, {
    value: openEditFont?.value?.fontFamily ?? defaultFontFamily,
    onChange: newFontFamily => {
      onChange("fontFamily", newFontFamily);
    }
  }, getFontFamilies().map(f => /*#__PURE__*/React__default.createElement(SelectItem, {
    key: f.id,
    value: f.value
  }, /*#__PURE__*/React__default.createElement("div", {
    style: {
  ...
  }, getFontWeights().map(f => /*#__PURE__*/React__default.createElement(SelectItem, {
    key: f.id,
    value: f.value
  }, f.label))), /*#__PURE__*/React__default.createElement(StyledSelect, {
  ...
  }, getLineHeights().map(f => /*#__PURE__*/React__default.createElement(SelectItem, {
    key: f.id,
    value: f.value
...
const FontColorConfigsModal = ({
  ...
  const editorContext = useEditorContext();
  const [activeSidebar, setActiveSidebar] = useState(sidebarContents[0].id);
  ...
  return /*#__PURE__*/React__default.createElement(Modal, {
    ...
    mode: "center-huge",
    headerLine: true
  }, /*#__PURE__*/React__default.createElement(ModalRoot$1, null, /*#__PURE__*/React__default.createElement(Sidebar$1, null, /*#__PURE__*/React__default.createElement(SidebarContent$1, null, sidebarContents.map(sidebarContent => /*#__PURE__*/React__default.createElement(SidebarButton$1, {
...
const Trigger = styled$1.button.withConfig({
  displayName: "LanguageSelect__Trigger",
  componentId: "sc-18nvvwp-0"
})(["all:unset;box-sizing:border-box;display:flex;align-items:center;gap:4px;height:28px;padding:0 6px;border-radius:2px;", ";box-shadow:0 0 0 1px ", ";transition:box-shadow 0.1s;@media (hover:hover){cursor:pointer;&:hover{box-shadow:0 0 0 1px ", ";}}&:focus-visible{box-shadow:0 0 0 2px ", ";}"], Fonts.body, Colors.black10, Colors.black20, Colors.focus);
const Anchor = styled$1.div.withConfig({
  displayName: "LanguageSelect__Anchor",
  componentId: "sc-18nvvwp-1"
})(["position:relative;"]);
const Popover = styled$1.div.withConfig({
  displayName: "LanguageSelect__Popover",
  componentId: "sc-18nvvwp-2"
})(["position:absolute;top:calc(100% + 4px);right:0;z-index:100200;min-width:220px;max-height:420px;overflow-y:auto;padding:4px 0;background:#fff;border:1px solid ", ";border-radius:2px;box-shadow:0px 2px 14px 0px rgba(0,0,0,0.15);"], Colors.black10);
const GroupLabel = styled$1.div.withConfig({
  displayName: "LanguageSelect__GroupLabel",
  componentId: "sc-18nvvwp-3"
})(["", ";color:", ";padding:6px 10px 4px;"], Fonts.label, Colors.black40);
const Separator = styled$1.div.withConfig({
  displayName: "LanguageSelect__Separator",
  componentId: "sc-18nvvwp-4"
})(["height:1px;margin:4px 0;background:", ";"], Colors.black10);
const Option = styled$1.button.withConfig({
  displayName: "LanguageSelect__Option",
  componentId: "sc-18nvvwp-5"
})(["all:unset;box-sizing:border-box;display:flex;align-items:center;gap:8px;width:100%;min-height:28px;padding:0 10px;", ";color:#000;font-weight:", ";@media (hover:hover){cursor:pointer;&:hover{background:#daeafd;}}&:focus-visible{background:#daeafd;}"], Fonts.body, ({
  $isSelected
}) => $isSelected ? 600 : 400);
const Flag = styled$1.img.withConfig({
  displayName: "LanguageSelect__Flag",
  componentId: "sc-18nvvwp-6"
})(["width:20px;height:20px;object-fit:contain;flex-shrink:0;"]);
const Check = styled$1.span.withConfig({
  displayName: "LanguageSelect__Check",
  componentId: "sc-18nvvwp-7"
})(["margin-left:auto;color:", ";"], Colors.black40);
const Name = styled$1.span.withConfig({
...
function LanguageSelect({
  ...
  const renderOption = (code, isSelected, onSelect) => /*#__PURE__*/React__default.createElement(Option, {
    key: code,
    type: "button",
  ...
  }, getFlagUrl(code) ? /*#__PURE__*/React__default.createElement(Flag, {
    src: getFlagUrl(code),
    alt: ""
  }) : null, /*#__PURE__*/React__default.createElement(Name, null, localeName(code)), isSelected ? /*#__PURE__*/React__default.createElement(Check, null, "\u2713") : null);
  ...
  }, getFlagUrl(contentLocale) ? /*#__PURE__*/React__default.createElement(Flag, {
    src: getFlagUrl(contentLocale),
    alt: ""
  }) : null, /*#__PURE__*/React__default.createElement(Name, null, localeName(contentLocale))), isOpen && /*#__PURE__*/React__default.createElement(Popover, null, /*#__PURE__*/React__default.createElement(GroupLabel, null, t("editor.language.content")), contentLocales.map(locale => renderOption(locale.code, locale.code === contentLocale, () => onContentLocaleChange(locale.code))), /*#__PURE__*/React__default.createElement(Separator, null), /*#__PURE__*/React__default.createElement(GroupLabel, null, t("editor.language.ui")), uiLocales.map(code => renderOption(code, code === uiLocale, () => onUiLocaleChange(code)))));
}
...
const EditorTopBar = ({
  ...
  return /*#__PURE__*/React__default.createElement(TopBar, {
    ...
    style: {
      background: showRightSidebar ? Colors.black10 : "transparent"
    }
  }, t("editor.sidebar.properties")), /*#__PURE__*/React__default.createElement(ButtonGhost, {
    icon: Icons.Device,
    hideLabel: true,
  ...
  }, !isAdminTemplate && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(LanguageSelect, {
 ...
 * group.
 */
const StyledPreview = styled.span.withConfig({
  displayName: "EditorSectionRow__StyledPreview",
  componentId: "sc-1wckczo-1"
})(["position:relative;flex:0 0 auto;width:48px;height:34px;border-radius:4px;background:", ";border:1px solid ", ";overflow:hidden;display:flex;align-items:center;justify-content:center;"], Colors.black5, Colors.black10);
 ...
 */
const StyledInitials = styled.span.withConfig({
  displayName: "EditorSectionRow__StyledInitials",
  componentId: "sc-1wckczo-3"
})(["font-size:11px;font-weight:600;letter-spacing:0.04em;color:", ";text-transform:uppercase;"], Colors.black500);
const StyledLabel = styled.span.withConfig({
  displayName: "EditorSectionRow__StyledLabel",
  componentId: "sc-1wckczo-4"
})(["flex:1;min-width:0;font-size:12px;line-height:1.35;color:", ";display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;"], Colors.black900);
...
const StyledGroup = styled.section.withConfig({
...
})(["position:sticky;top:0;z-index:1;margin:0 0 4px;background:", ";font-size:10px;font-weight:700;letter-spacing:0.09em;text-transform:uppercase;color:", ";"], Colors.white, Colors.black500);
 ...
 */
const StyledHeadingButton = styled.button.withConfig({
  ...
  $canToggle
}) => $canToggle ? "pointer" : "default", Colors.blue60);
 ...
 */
const StyledChevron = styled.svg.withConfig({
  displayName: "EditorSectionGroup__StyledChevron",
  componentId: "sc-1ycdt4p-3"
})(["flex:none;align-self:center;width:8px;height:8px;color:", ";transform:rotate(", ");transition:transform 120ms ease;@media (prefers-reduced-motion:reduce){transition:none;}"], Colors.black40, ({
  $open
}) => $open ? "90deg" : "0deg");
const StyledCount = styled.span.withConfig({
  displayName: "EditorSectionGroup__StyledCount",
  componentId: "sc-1ycdt4p-4"
})(["font-weight:500;letter-spacing:0;color:", ";"], Colors.black40);
const StyledRows = styled.div.withConfig({
  displayName: "EditorSectionGroup__StyledRows",
  componentId: "sc-1ycdt4p-5"
})(["display:flex;flex-direction:column;gap:2px;"]);
const StyledPlaceholderRow = styled.div.withConfig({
  displayName: "EditorSectionGroup__StyledPlaceholderRow",
  componentId: "sc-1ycdt4p-6"
})(["display:flex;align-items:center;gap:10px;padding:5px 6px;&::before{content:\"\";width:48px;height:34px;border-radius:4px;background:", ";}&::after{content:\"\";flex:1;height:10px;border-radius:3px;background:", ";}"], Colors.black5, Colors.black5);
const StyledMore = styled.button.withConfig({
  displayName: "EditorSectionGroup__StyledMore",
  componentId: "sc-1ycdt4p-7"
})(["margin:4px 0 0 6px;padding:0;border:none;background:none;font:inherit;font-size:11.5px;color:", ";cursor:pointer;&:disabled{color:", ";cursor:default;}"], Colors.blue60, Colors.black40);
const StyledEmpty = styled.p.withConfig({
  displayName: "EditorSectionGroup__StyledEmpty",
  componentId: "sc-1ycdt4p-8"
})(["margin:0 0 0 6px;font-size:11.5px;color:", ";"], Colors.black500);
...
const EditorSectionGroup = ({
  ...
  const [isFolded, setIsFolded] = useState(() => storageKey ? isGroupCollapsed(storageKey) : false);
  ...
  return /*#__PURE__*/React__default.createElement(StyledGroup, {
    ref: rootRef
  }, /*#__PURE__*/React__default.createElement(StyledHeading, null, /*#__PURE__*/React__default.createElement(StyledHeadingButton, {
    type: "button",
    $canToggle: canToggle,
    "aria-expanded": canToggle ? isOpen : undefined,
    onClick: toggle
  }, canToggle ? /*#__PURE__*/React__default.createElement(StyledChevron, {
    $open: isOpen,
    viewBox: "0 0 8 8",
    "aria-hidden": "true",
    focusable: "false"
    ...
    d: "M2 0 L7 4 L2 8 Z",
    fill: "currentColor"
  })) : null, label, typeof count === "number" && count > 0 ? /*#__PURE__*/React__default.createElement(StyledCount, null, count) : null)), isOpen ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(StyledRows, null, rows.map(row => /*#__PURE__*/React__default.createElement(EditorSectionRow, {
    key: row.key,
    label: row.label,
...
})(["position:relative;display:flex;align-items:center;padding:10px 12px 8px;background:", ";"], Colors.white);
const StyledInput = styled.input.withConfig({
  displayName: "EditorSectionSearch__StyledInput",
  componentId: "sc-vrb0yz-1"
})(["width:100%;height:30px;padding:0 26px 0 28px;border:1px solid ", ";border-radius:6px;background:", ";font:inherit;font-size:12px;color:", ";box-sizing:border-box;&::placeholder{color:", ";}&:focus{outline:none;border-color:", ";background:", ";}"], Colors.black10, Colors.black5, Colors.black900, Colors.black40, Colors.blue50, Colors.white);
const StyledIcon = styled.span.withConfig({
  displayName: "EditorSectionSearch__StyledIcon",
  componentId: "sc-vrb0yz-2"
})(["position:absolute;left:21px;display:flex;color:", ";pointer-events:none;"], Colors.black40);
const StyledClear = styled.button.withConfig({
  displayName: "EditorSectionSearch__StyledClear",
  componentId: "sc-vrb0yz-3"
})(["position:absolute;right:20px;width:16px;height:16px;display:grid;place-items:center;padding:0;border:none;border-radius:50%;background:", ";color:", ";font-size:11px;line-height:1;cursor:pointer;"], Colors.black20, Colors.white);
...
const EditorSectionSearch = ({
  ...
  clearLabel,
  onChange
}) => /*#__PURE__*/React__default.createElement(StyledField, null, /*#__PURE__*/React__default.createElement(StyledIcon, {
  "aria-hidden": "true"
}, /*#__PURE__*/React__default.createElement("svg", {
  width: "13",
  height: "13",
...
, {
  ...
  onChange: event => onChange(event.target.value)
}), value ? /*#__PURE__*/React__default.createElement(StyledClear, {
  type: "button",
...
})(["padding:6px;font-size:12px;color:", ";"], Colors.black500);
const EditorSections = ({
  ...
  const localGroups = useMemo(() => Object.keys(localItemsByGroup), [localItemsByGroup]);
   ...
   */
  const fetchPage = useCallback((page, options) => {
  ...
  const discoveredForModeRef = useRef(null);
   ...
   */
  const loadEntryPage = useCallback((entry, page) => {
  ...
  return /*#__PURE__*/React__default.createElement(StyledPanel, null, /*#__PURE__*/React__default.createElement(EditorSectionSearch, {
    value: query,
    ...
    onChange: setQuery
  }), /*#__PURE__*/React__default.createElement(StyledList, null, isLoadingList && /*#__PURE__*/React__default.createElement(EditorSectionsSkeleton, null), !isLoadingList && entries.length === 0 && /*#__PURE__*/React__default.createElement(StyledMessage, null, t("noData"), "!"), !isLoadingList && isSearchingTemplates && /*#__PURE__*/React__default.createElement(EditorSectionGroup, {
    ...
    return /*#__PURE__*/React__default.createElement(EditorSectionGroup, {
      key: entry.id,
      label: entry.label,
      count: rows.length,
      rows: rows,
  ...
  }), !isLoadingList && !isSearchingTemplates && query && !hasAnyRow && /*#__PURE__*/React__default.createElement(StyledMessage, null, t("editor.sidebar.sections.search.empty"))));
};
...
const EditorLeftSidebar = ({
  ...
  return /*#__PURE__*/React__default.createElement(StyledEditorLeftSidebarRoot, {
    ...
    ref: sidebarNodeRef
  }, /*#__PURE__*/React__default.createElement(StyledEditorLeftSidebarTitle, null, sidebarConfig.title), /*#__PURE__*/React__default.createElement(HorizontalLine, null), /*#__PURE__*/React__default.createElement(StyledEditorLeftSidebarGroup, {
...
function EditorBackendInitializer(props) {
  ...
  if (!enabled) {
    return /*#__PURE__*/React__default.createElement(AuthenticationScreen, null, /*#__PURE__*/React__default.createElement(SkeletonEditor, null));
  }
  if (error) {
...
function useBuiltContent(editorContext, config, rawContent, externalData, onExternalDataChange) {
  ...
  const inputConfigTokenFonts = useRef(config.tokens?.fonts);
  const inputConfigTokenColors = useRef(config.tokens?.colors);
...
const EditorContent = ({
   ...
   */
  const [localUiLocale, setLocalUiLocale] = useState(undefined);
...
function BlocksControls({
  ...
  const dropRejectionMessage = sortable.active && !isBlockBeingDragged ? getDropRejectionMessage({
    isFixedSlot: isEntryComponentOrComponentFixed,
    canAcceptDraggedComponent: canDraggedComponentBeDropped,
  ...
  const hasCollectionStartTarget = !isDroppableDisabled && isActivePathInDifferentCollection && sortable.activeIndex < sortable.index && index === 0;
  const hasCollectionEndTarget = !isDroppableDisabled && isActivePathInDifferentCollection && sortable.activeIndex > sortable.index && index === length - 1;
  ...
  return /*#__PURE__*/React__default.createElement(SelectionFrameController, {
    isActive: isActive,
    ...
    edgeDropTargets: /*#__PURE__*/React__default.createElement(Fragment, null, hasCollectionStartTarget && /*#__PURE__*/React__default.createElement(CollectionEdgeDropTarget, {
      ...
      path: path,
      position: "before"
    }), hasCollectionEndTarget && /*#__PURE__*/React__default.createElement(CollectionEdgeDropTarget, {
      id: id,
      direction: direction,
      path: path,
      position: "after"
...
function EasyblocksCanvas({
  ...
  if (shouldNotRender) {
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(SkeletonEditorCanvasArea$1, null));
  }
